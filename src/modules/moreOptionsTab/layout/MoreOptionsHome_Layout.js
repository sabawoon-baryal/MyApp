...
export default class MoreOptionsHome_Layout extends Component {
  handleThePress = () => {
          ...
          <View style={{ paddingBottom: 20 }}>
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  <Icon name="unlock-alt" size={22} color="green" />
                </View>
                <View
                  style={{
                    flex: 1,
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  <Icon name="envelope" size={22} color="rgb(237, 133, 7)" />
                </View>
                <View
                  style={{
                    flex: 1,
          ...
          <View style={{ paddingBottom: 20 }}>
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  <Icon name="phone-square" size={22} color="rgb(5, 181, 34)" />
                </View>
                <View
                  style={{
                    flex: 1,
            ...
            >
              <View style={{ flexDirection: "row" }}>
                ...
                >
                  <Icon name="list-alt" size={22} color="navy" />
                </View>
                <View
                  style={{
                    flex: 1,
